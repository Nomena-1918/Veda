...
public class QueryUtils {
    ...
    public static Field[] getColumnsWithoutPrimary(Class c) {
        Field[] fields = c.getDeclaredFields();
    ...
    public static Field[] getColumns(Class c) {
        Field[] fields = c.getDeclaredFields();
        LinkedList<Field> liste = new LinkedList<>();
        for (Field f : fields) {
            Annotation annote = f.getAnnotation(Column.class);
    ...
    public static Object mapResultSet(Connection connex, ResultSet result, Object object, HashMap<Field, String> columns, DAOInterface daoInterface) throws Exception {
        Object obj = object;
        ...
        for (Map.Entry<Field, String> entry : columns.entrySet()) {
            ...
            if (annote != null) {
                ...
                Object objet = daoInterface.select(connex, type, foreignValue)[0];
                f.set(obj, objet);
                continue;
            }
            String fieldType = type.getSimpleName();
